...
function test_polynomial() {
  ...
  assert_throws("Coefficients array incorrect length for degree.", function() {
    new pn.Polynomial(2, [Q(1, 2), Q(2, 3)]);
  });
  assert_throws("Coefficients array incorrect length for degree.", function() {
    new pn.Polynomial(0, [Q(1, 2), Q(2, 3)]);
  });

  assert_eq("4", pn.Polynomial.createFromZ(4).pretty());
  assert_eq("3/4", pn.Polynomial.createFromQ(Q(3, 4)).pretty());

  var p0 = new pn.Polynomial(1, [Q(1, 2), Q(2, 3)]);
  ...
  var p1 = new pn.Polynomial(2, [Q(1, 3), Q(1, 2), Q(5, 1)]);
  ...
  var p6 = new pn.Polynomial(3, [Q(-9261, 6859),
                                 Q(26459, 6859),
                                 Q(-25200, 6859),
                                 Q(-8000, 6859)]);
  var p7 = new pn.Polynomial(1, [Q(-21, 19),
                                 Q(20, 19)]);

  assert_eq("194481/130321 + -740859/130321*t + 1058380/130321*t^2 + -336000/130321*t^3 + -160000/130321*t^4", p6.mulP(p7).pretty());

  var p8 = new pn.Polynomial(2, [Q(2, 1), Q(2, 1), Q(1, 2)]);
  var p9 = new pn.Polynomial(1, [Q(1, 1), Q(1, 1)]);
